...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print(EnumData.P1.getValue());
        System.out.println(lesson1.task_1(TEST_STRING));

        System.out.print(EnumData.P2.getValue());
        System.out.println(lesson1.task_2(TEST_STRING, "Hello world!"));

        System.out.print(EnumData.P3.getValue());
        System.out.println(lesson1.task_3("New String"));
        ...
        System.out.print(EnumData.P6.getValue());
        System.out.println(lesson1.task_6(TEST_STRING));

        System.out.print(EnumData.P7.getValue());
        System.out.println(lesson1.task_7(TEST_STRING));

        System.out.print(EnumData.P8.getValue());
        System.out.println(lesson1.task_8(TEST_STRING));

        System.out.print(EnumData.P9.getValue());
        System.out.println(lesson1.task_9(TEST_STRING));

        System.out.print(EnumData.P10.getValue());
        System.out.println(lesson1.task_10(TEST_STRING));

        System.out.print(EnumData.P11.getValue());
        System.out.println(lesson1.task_11(TEST_STRING));

        System.out.print(EnumData.P12.getValue());
        System.out.println(lesson1.task_12(TEST_STRING));
        ...
        System.out.print(EnumData.P14.getValue());
        System.out.println(lesson1.task_14(TEST_STRING));

        System.out.print(EnumData.P15.getValue());
        System.out.println(lesson1.task_15(TEST_STRING));
    }
}
